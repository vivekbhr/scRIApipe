...
## not printing barcode ranks for now, (getRanks)
## this is because this shit doesn't return the metadata if executed from Rmd
sf_barcodeRanks <- DropletUtils::barcodeRanks(sf)
barcodes_touse <- colnames(sf)[tot_count > sf_barcodeRanks$inflection]
